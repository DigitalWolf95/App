...
export const mainDrawerItems: UiMaterialFosterDrawerItem[] = [
  {
    id: 100,
    type: 'MainItem',
    label: 'Projects',
...
export const adminDrawerItems: UiMaterialFosterDrawerItem[] = [
  {
    id: 1000,
    type: 'MainItem',
    label: 'Basic Info',
    to: '/admin',
    subItems: [
      { id: 701, type: 'SubItem', label: 'Social Networks', to: '/admin/social' },
      {
        id: 702,
        type: 'SubItem',
        label: 'Articles',
  ...
  },
  {
    ...
    label: 'Home',
    to: '/admin',
    subItems: [{ id: 2001, type: 'SubItem', label: 'Slider', to: '/admin/home-slider' }],
  },
  {
    id: 3000,
    type: 'MainItem',
