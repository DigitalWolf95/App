...
export interface UiMaterialConfirmDialogProps {
...
export function UiMaterialConfirmDialog({ isOpen, title, content, onConfirm, onClose }: UiMaterialConfirmDialogProps) {
